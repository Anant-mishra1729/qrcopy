...
then
    echo -e "python3-\e[31mvenv\e[0m could not be found. Please install python3-venv before running this script."
    exit 1
fi
...
echo -e "\e[1m\e[36mEnter your Pastebin API key in ~/.config/qrcopy/qrcopy.conf (leave blank if you don't have one): \e[0m"
